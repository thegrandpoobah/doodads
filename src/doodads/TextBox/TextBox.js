(function () {
	...
	doodads.setup().constructor(function () {
		...
		bindEvents: function () {
			this._input.bind('keyup', this.onKeyUp$debounced).bind('focus.cmp', this.onFocus$proxy).bind('blur.cmp', this.onBlur$proxy);
		...
		onFocus: function (e) {
			...
			window.setTimeout(function () {
				...
				self._input.focus().bind('focus.cmp', self.onFocus$proxy).bind('blur.cmp', self.onBlur$proxy);
			}, 0);
